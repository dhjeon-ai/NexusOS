---
name: ProjectOS
description: Use when starting a new repository and the project needs a durable operating structure with entry documents, rule nodes, component maps, and task flow that stay cheap to load over time.
---
...
- Layer 1: core structure, index, and low-context document contracts
...
2. Read `references/node-model.md` and `references/bootstrap-flow.md`.
...
6. Run `scripts/bootstrap_projectos.py --root <PROJECT_ROOT> --project-name <NAME>` after the user confirms the scope.
